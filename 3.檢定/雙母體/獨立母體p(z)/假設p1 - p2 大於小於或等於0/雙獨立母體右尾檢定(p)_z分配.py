...
print(f'因為z統計量 {z_test_stastic} 大於臨界值 {right_limit},所以拒絕H0')
...
x=p1_hat-p2_hat
right_limit = stats.norm.ppf(1-alpha,P1_P2,((p_pooled*(1-p_pooled))*(1/n1+1/n2))**(1/2))
print(f'因為x {x} 大於臨界值 {right_limit},所以拒絕H0')
